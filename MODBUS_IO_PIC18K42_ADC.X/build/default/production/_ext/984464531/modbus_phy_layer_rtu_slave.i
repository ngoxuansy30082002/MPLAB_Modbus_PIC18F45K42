# 1 "../modbus/modbus_phy_layer_rtu_slave.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../modbus/modbus_phy_layer_rtu_slave.c" 2
# 22 "../modbus/modbus_phy_layer_rtu_slave.c"
...
# 22 "../modbus/modbus_phy_layer_rtu_slave.c" 2
...
# 27 "../modbus/modbus_phy_layer_rtu_slave.c" 2
...
# 28 "../modbus/modbus_phy_layer_rtu_slave.c" 2
...
# 29 "../modbus/modbus_phy_layer_rtu_slave.c" 2
...
_Bool modbus_timeout_enabled = 0;
modbusrx modbus_rx;
data transfer_data;
...
# 63 "../modbus/modbus_phy_layer_rtu_slave.c"
enum {
...
void RCV_ON(void) {
    uint8_t c;
    int j = 0;
# 167 "../modbus/modbus_phy_layer_rtu_slave.c"
...
void modbus_check_timeout(void) {
    ...
    if (flag_has_data == 1) {
# 273 "../modbus/modbus_phy_layer_rtu_slave.c"
        if (modbus_timeout_enabled && (timer_modbus >= 5))
        {
# 286 "../modbus/modbus_phy_layer_rtu_slave.c"
            flag_has_data = 0;
            modbus_timeout_now();
...
void modbus_calc_crc(unsigned char data) {
    ...
    uIndex = (uint8_t) (modbus_serial_crc.b[1]) ^ data;
...
void modbus_serial_putc(unsigned char c) {
# 323 "../modbus/modbus_phy_layer_rtu_slave.c"
    UART1_Write(c);
...
# 343 "../modbus/modbus_phy_layer_rtu_slave.c"
void modbus_serial_send_start(unsigned char to, unsigned char func) {
    modbus_serial_crc.d = 0xFFFF;
    modbus_serial_new = FALSE;
    RCV_OFF();
...
# 357 "../modbus/modbus_phy_layer_rtu_slave.c"
...
# 398 "../modbus/modbus_phy_layer_rtu_slave.c"
    RCV_ON();
...
void incomming_modbus_serial(void) {
    char c;
# 428 "../modbus/modbus_phy_layer_rtu_slave.c"
    c = U1RXB;
    ...
    if (!modbus_serial_new) {
        if (modbus_serial_state == MODBUS_GETADDY) {
            ...
            if (modbus_rx.len >= 255) {
                modbus_rx.len = 255 - 1;
            }
# 478 "../modbus/modbus_phy_layer_rtu_slave.c"
...
void incomming_hmi_serial(void) {
    ...
    if (finish_receive == 0) {
        ...
        c = U2RXB;
        data_buffer[index] = c;
        if (data_buffer[0] == 0x65 || data_buffer[0] == 0x70) {
...
# 534 "../modbus/modbus_phy_layer_rtu_slave.c"
            count_end = 0;
            index = 0;
