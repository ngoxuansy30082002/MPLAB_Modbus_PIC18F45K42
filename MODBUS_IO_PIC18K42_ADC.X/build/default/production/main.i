...
# 133 "./mcc_generated_files/interrupt_manager.h"
...
# 69 "./mcc_generated_files/uart2.h"
...
# 127 "./mcc_generated_files/mcc.h"
void WWDT_SoftEnable(void);
# 139 "./mcc_generated_files/mcc.h"
void WWDT_SoftDisable(void);
# 152 "./mcc_generated_files/mcc.h"
void WWDT_TimerClear(void);
# 165 "./mcc_generated_files/mcc.h"
_Bool WWDT_TimeOutStatusGet(void);
# 179 "./mcc_generated_files/mcc.h"
...
# 26 "./../modbus/modbus_app_layer.h" 2
...
uint8_t eeprom_buffer_write[6];
uint8_t eeprom_buffer_read[6];
            ...
            if (modbus_rx.address == modbus_address) {
                ...
                switch (modbus_rx.func) {
                    ...
                    case FUNC_READ_HOLDING_REGISTERS:
                    {
                        ...
                        if (addr_start >= 400 && (addr_start + quantity_regs <= 403)) {
