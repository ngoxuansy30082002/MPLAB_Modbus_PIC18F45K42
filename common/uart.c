...
#if defined(STACK_USE_UART1) ||defined(STACK_USE_UART2)
...
uint8_t ReadStringUART1(uint8_t *Dest, uint8_t BufferLen)
{
    uint8_t c;
    uint8_t count = 0;
    while (BufferLen--) {
...
uint8_t ReadStringUART2(uint8_t *Dest, uint8_t BufferLen)
{
    uint8_t c;
    uint8_t count = 0;
    while (BufferLen--) {
